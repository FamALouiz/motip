...
class TestRandomTNGeneration:
    ...
    def test_random_tn_generation(self):
        ...
        tn = generate_random_tn(num_tensors=5, max_rank=3, max_dim=4, seed=42)
    ...
    def test_same_seed_produces_same_tn(self):
        ...
        tn1 = generate_random_tn(num_tensors=5, max_rank=3, max_dim=4, seed=42)
        tn2 = generate_random_tn(num_tensors=5, max_rank=3, max_dim=4, seed=42)
